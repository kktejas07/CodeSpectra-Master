...
```bash
# Migrations live under ./supabase/migrations/ (repo root).
...
You'll need to add these to your deployment environment (e.g. `.env.local` locally or your host’s secret store):
