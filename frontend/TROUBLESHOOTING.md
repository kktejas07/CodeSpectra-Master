...
```bash
# In your host environment or .env.local, verify you have:
...
2. Click "Console" tab
3. Look for messages starting with `[CodeSpectra]`

**Common Log Messages:**
- `[CodeSpectra] Attempting login with email: ...` - Login attempt started
- `[CodeSpectra] Login result:` - Shows the result object with success/error
- `[CodeSpectra] Demo user created:` - Demo user successfully created
- `[CodeSpectra] Starting demo user setup...` - Setup API called
...
### File Locations
- Environment variables: `.env.local` locally or your host’s environment configuration
