      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-3 mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            <div className="w-12 h-12 bg-linear-to-br from-primary to-primary/60 rounded-lg flex items-center justify-center shadow-lg">
              <Code2 className="w-7 h-7 text-primary-foreground" />
            </div>
            <span className="text-3xl font-bold bg-linear-to-r from-primary to-primary/60 bg-clip-text text-transparent">CodeSpectra</span>
          </div>
          <div>
          ...
          <div className="bg-muted/50 border border-border/50 rounded-lg p-4 space-y-3">
            ...
            <ul className="text-xs space-y-2 text-muted-foreground">
              ...
              <li className="flex gap-2">
                ...
                <span>
                  Check that SUPABASE_SERVICE_ROLE_KEY or SUPABASE_SECRET_KEY (and anon or publishable key) is set in
                  `.env.local`
                </span>
              </li>
              <li className="flex gap-2">
