...
import { Users, Search, Edit2, Trash2, MoreVertical, Shield } from 'lucide-react'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
interface User {
  ...
  name: string
  email: string
  /** Access level (`tenant_admin`, `superadmin`, `user`; legacy `admin` normalized in UI). */
  role: string
...
interface UserManagementTableProps {
  ...
  /** Opens role-only dialog (display name is not edited here). */
