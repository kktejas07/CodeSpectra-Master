...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    badge: 'Updated',
    submenu: [
      { id: 'learning-all', label: 'All Courses', href: '/dashboard/learning', icon: <BookOpen className="w-4 h-4" /> },
      { id: 'video', label: 'Video Courses', href: '/dashboard/learning?filter=video', icon: <Play className="w-4 h-4" /> },
      { id: 'audio', label: 'Audio Courses', href: '/dashboard/learning?filter=audio', icon: <Volume2 className="w-4 h-4" /> },
      { id: 'text', label: 'Text Courses', href: '/dashboard/learning?filter=text', icon: <BookOpen className="w-4 h-4" /> },
    ]
  },
  {
    id: 'achievements',
